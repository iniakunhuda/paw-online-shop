                    ...
                    <div class="col-12">
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table responsive table-condensed" style="display: none">
                                        <thead>
                                            <tr>
                                                <th>Nomor Nota</th>
                                                <th>Order Pada</th>
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <h2>@currency($total_produsen)</h2>
                            </div>
                        </div>

                        <div class="card mb-2">
                            <div class="card-body">
                                <h4>Total Pendapatan Paguyuban</h4>
                                <h2>@currency($total_paguyuban)</h2>
                            </div>
                        </div>
