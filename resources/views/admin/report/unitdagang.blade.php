    ...
    <div class="section mt-2">
        <div class="row">
            <div class="col-12 col-sm-12 mb-2">
                ...
                <div class="row">
                    <div class="col-12">
                        <h1 class="mt-3 mb-0">Laporan Unit Dagang</h1>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table responsive table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            @endphp
                                            @if(count($trans) > 0)
                                                @foreach($trans as $merchant_id => $dt)
                                                    @php
                                                        $count_row += 1;
                                                    @endphp
                                                    <tr>
                                                        <td>{{ $_merchants[$merchant_id]['name'] }}</td>
    ...
    $('table').DataTable({
        ...
        buttons: [
            $.extend( true, {}, excelCommon, {
                extend: 'excelHtml5',
                footer: true,
                title: "Laporan Unit Dagang {{ date('d M Y', $start) }} - {{ date('d M Y', $end) }}",
