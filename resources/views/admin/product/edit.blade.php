                    ...
                    @method('PUT')
                        ...
                        <div class="dropdown">
                            <div class="form-group boxed">
                                ...
                                <select id="parent_category" class="form-control" onchange="changeParentCategory(this)" name="parent_category" required>
                                    ...
                                    <option value="{{ $cat->_id }}" {{ ((isset($product->parent_category)) && ($product->parent_category == $cat->_id)) ? 'selected' : '' }}>{{ $cat->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <textarea cols="20" class="form-control text-editor" id="editor1" rows="5" name="desc" required>{{ $product->desc }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <textarea cols="20" class="form-control text-editor" id="editor2" rows="10" name="desc_long" required>{{ $product->desc_long }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="form-group boxed">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="text" class="form-control"  name="price[real_price]" value="{{ $product->price['real_price'] }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group boxed">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="text" class="form-control"  name="price[discount_price]" value="{{ $product->price['discount_price'] }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-control" name="price[merchant_price]" value="{{ $product->price['merchant_price'] ?? '0' }}" required>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="text" class="form-control" name="min_order" value="{{ $product->min_order ?? '1' }}" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="input-wrapper">
                                        <label class="label">Minimum pesan H-berapa (Misal h-3, isi dengan 3. Isi 0 jika tidak ada minimal order berapa hari)</label>
                                        <input type="number" class="form-control" name="min_hari" value="{{ $product->min_hari ?? '0' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    @if(isset($product->parent_category))
        changeParentCategory($('#parent_category'), '{{ $product->category }}');
    @endif
</script>    
@endpush